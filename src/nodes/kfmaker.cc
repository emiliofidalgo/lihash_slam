...
int main(int argc, char** argv) {
  ...
  // ROS Interface
  message_filters::Subscriber<sensor_msgs::PointCloud2> points_sub(nh, "points", 1);
  message_filters::Subscriber<nav_msgs::Odometry> pose_sub(nh, "pose", 1);
  message_filters::TimeSynchronizer<sensor_msgs::PointCloud2, nav_msgs::Odometry> sync(points_sub, pose_sub, 1);
